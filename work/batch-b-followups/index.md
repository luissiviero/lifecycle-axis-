...
- [intent.md](intent.md) — status: approved; approved-by: luissiviero; The sdlc-gate triage step runs untrusted, the adopter placeholder handle can approve, and the chain check rejects a fully retired item; three small fixes the last work items named but could not make.
