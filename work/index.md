...
| [deploy-gate](deploy-gate/index.md) | The deploy path fails open; every route to production must fail closed on a named human | plan | in-review | in-review | in-review | plan.md -> in-review by claude |
