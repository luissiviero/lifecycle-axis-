...
| [session-chaining](session-chaining/index.md) | The kit never says who manages session context, so the owner has been doing it by hand | intent | in-review | — | — | intent.md -> in-review by claude |
