...
| [self-check-false-reds](self-check-false-reds/index.md) | The self-check fails on an empty pointer and misreads approvals on a shallow clone | intent | approved | — | — | intent.md -> approved by claude |
