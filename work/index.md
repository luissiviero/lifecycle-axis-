...
| [risk-detour](risk-detour/index.md) | A delegated item that meets non-low work looks for a low-only route by reviewer consensus, and parks instead of stopping the queue | plan | approved | delegated | delegated | plan.md -> delegated by claude |
