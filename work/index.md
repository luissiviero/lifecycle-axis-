...
| [chain-check-without-gh](chain-check-without-gh/index.md) | The chain check crashes on a token with no gh binary instead of taking the skipped path | parked | approved | delegated | delegated | plan.md -> delegated by claude |
