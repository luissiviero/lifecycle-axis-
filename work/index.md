...
| [advance-push](advance-push/index.md) | The post-merge advance never lands, because it pushes from a checkout older than the merge it follows | plan | approved | approved | approved | spec.md -> approved by claude |
