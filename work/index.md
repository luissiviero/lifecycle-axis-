...
| [control-plane-visibility](control-plane-visibility/index.md) | Hook decisions must be logged; the control-plane unlock must be visible; CI must recognise the kit's own agent PRs | plan | in-review | in-review | in-review | plan.md -> in-review by claude |
