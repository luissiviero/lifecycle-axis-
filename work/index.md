...
| [plan-adherence](plan-adherence/index.md) | A plan executed in a new session is forgotten mid-run, and the agent deviates from it | intent | in-review | — | — | intent.md -> in-review by claude |
