...
| [advance-push](advance-push/index.md) | The post-merge advance never lands, because it pushes from a checkout older than the merge it follows | plan | superseded | superseded | superseded | plan.md -> superseded by luissiviero |
...
| [approve-tap-regenerates-index](approve-tap-regenerates-index/index.md) | The approval tap commits an approval whose indexes are stale; make the tap regenerate what it changes | plan | superseded | superseded | superseded | plan.md -> superseded by luissiviero |
...
| [chain-check-without-gh](chain-check-without-gh/index.md) | The chain check crashes on a token with no gh binary instead of taking the skipped path | parked | approved | delegated | delegated | PR #112 -> in-review by github-actions[bot] |
| [ci-budget](ci-budget/index.md) | Reduce GitHub minutes, waiting time and wasted tokens; keep the crucial procedures, loosen the rest | plan | approved | approved | approved | PR #72 -> in-review by claude |
...
| [parked-marker-on-retired](parked-marker-on-retired/index.md) | A retired item still reads `parked` in the generated index | plan | superseded | superseded | superseded | plan.md -> superseded by luissiviero |
...
| [self-check-false-reds](self-check-false-reds/index.md) | The self-check fails on an empty pointer and misreads approvals on a shallow clone | plan | superseded | superseded | superseded | plan.md -> superseded by luissiviero |
