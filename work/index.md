...
| [approve-by-dispatch](approve-by-dispatch/index.md) | Give permission for the AI to change from one mode to the other when I request, without doing everything manually | intent | in-review | — | — | intent.md -> in-review by claude |
