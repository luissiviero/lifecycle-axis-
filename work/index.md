...
| [ci-budget](ci-budget/index.md) | Reduce GitHub minutes, waiting time and wasted tokens; keep the crucial procedures, loosen the rest | intent | in-review | — | — | intent.md -> in-review by claude |
...
| [run-queue-followups](run-queue-followups/index.md) | The chain check reports PASS on work it never saw; make it say so instead | plan | superseded | delegated | delegated | PR #58 -> in-review by claude |
