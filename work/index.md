...
| [band-detector](band-detector/index.md) | The band detector cannot see the breach it exists for | plan | approved | approved | approved | plan.md -> approved by luissiviero |
