...
| [session-chaining](session-chaining/index.md) | The kit never says who manages session context, so the owner has been doing it by hand | spec | approved | in-review | — | spec.md -> in-review by claude |
