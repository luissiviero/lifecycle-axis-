...
| [ci-budget](ci-budget/index.md) | Reduce GitHub minutes, waiting time and wasted tokens; keep the crucial procedures, loosen the rest | plan | approved | approved | approved | plan.md -> approved by claude |
