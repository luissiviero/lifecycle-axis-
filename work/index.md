...
| [retire-delegated-items](retire-delegated-items/index.md) | A delegated item cannot be retired into a green chain, and its retirement leaves the indexes stale | plan | approved | approved | approved | spec.md -> approved by luissiviero |
