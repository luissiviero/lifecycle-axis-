...
| [parked-marker-on-retired](parked-marker-on-retired/index.md) | A retired item still reads `parked` in the generated index | intent | in-review | — | — | intent.md -> in-review by claude |
