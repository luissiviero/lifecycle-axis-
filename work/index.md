...
| [deploy-gate](deploy-gate/index.md) | The deploy path fails open; every route to production must fail closed on a named human | plan | approved | approved | approved | plan.md -> in-review by claude |
