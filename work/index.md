...
| [retire-delegated-items](retire-delegated-items/index.md) | A delegated item cannot be retired into a green chain, and its retirement leaves the indexes stale | spec | approved | in-review | — | spec.md -> in-review by claude |
