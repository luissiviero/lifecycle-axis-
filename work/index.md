...
| [ci-budget](ci-budget/index.md) | Reduce GitHub minutes, waiting time and wasted tokens; keep the crucial procedures, loosen the rest | spec | approved | in-review | — | PR #69 -> in-review by claude |
