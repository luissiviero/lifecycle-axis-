...
| [retire-delegated-items](retire-delegated-items/index.md) | A delegated item cannot be retired into a green chain, and its retirement leaves the indexes stale | intent | in-review | — | — | intent.md -> in-review by claude |
