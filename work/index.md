...
| [approve-tap-regenerates-index](approve-tap-regenerates-index/index.md) | The approval tap commits an approval whose indexes are stale; make the tap regenerate what it changes | spec | approved | delegated | — | spec.md -> delegated by claude |
