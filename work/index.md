...
| [session-chaining](session-chaining/index.md) | The kit never says who manages session context, so the owner has been doing it by hand | plan | approved | approved | approved | PR #76 -> in-review by claude |
