...
---
# Make lifecycle-axis a reusable AI-native SDLC kit for Claude + Gemini projects

- [intent.md](intent.md) — status: superseded; approved-by: luissiviero; Turn the scaffold into a drop-in kit with an OKF knowledge layer and model-neutral gates.
