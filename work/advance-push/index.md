...
Last gate: - 2026-09-14T12:09:28Z | plan.md | approved -> approved | luissiviero | 4fdf262 | deviation: a new test file under kind fix is writable once, not "stays writable" as the hook header and spec C2 read it; the module's one fixture line (git clone -b main) is the owner's edit, the red and green sets were observed on a corrected copy outside the tree. 2 of 5
